# Simulação de Colisão Elástica entre Partículas
...
```
Isso garante que o projeto e suas bibliotecas sejam devidamente compilados e executados. Por isso é preciso ter o Raylib e gcc.
...
Com o objetivo de calcular a velocidade final, usei duas maneiras distintas:
